...
import Animated, { useAnimatedStyle, interpolateColor, useAnimatedScrollHandler, useAnimatedGestureHandler, useSharedValue, withSpring, withTiming, interpolate, withDelay, withRepeat, withSequence } from 'react-native-reanimated';
...
export default () => {
    ...
    return (
        <Animated.ScrollView style={[styles.scrollView, scrollViewAnimatedStyle]}
            onScroll={scrollHandler}
            scrollEventThrottle={16}
            contentContainerStyle={{ justifyContent: 'center', height: "100%", alignItems: 'center' }}
        >
